if (game:GetService("CoreGui")):FindFirstChild("VicatHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("VicatHub")).Enabled = not (game.CoreGui:FindFirstChild("VicatHub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("VicatHub/Library/") then
			makefolder("VicatHub/Library/");
		end;
		if not isfile(("VicatHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("VicatHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("VicatHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("VicatHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("VicatHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
