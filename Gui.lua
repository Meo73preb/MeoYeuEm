...
_G.Primary = _G.Primary or Color3.fromRGB(100, 100, 100)
_G.Dark = _G.Dark or Color3.fromRGB(22, 22, 26)
_G.Third = _G.Third or Color3.fromRGB(255, 0, 0)
...
function Update:SaveSettings() return false end
function Update:LoadAnimation() return false end
...
function Update:Window(Config)
	local WindowConfig = {
		Size = Config.Size or UDim2.new(0, 550, 0, 350),
